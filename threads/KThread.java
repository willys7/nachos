...
private static class prove_listen implements Runnable{
    static Communicator com = new Communicator();
    prove_listen(Communicator com){
        this.com = com;
    }
...
private static class prove_speack implements Runnable{
    static Communicator com = new Communicator();
    prove_speack(Communicator com){
        this.com = com;
    }
